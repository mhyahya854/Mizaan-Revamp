...
- Tasks: [PARTIAL] - typed task metadata helper, provider-backed task record creation, dedicated `/tasks` route/list UI, project-linked task creation/editing, task detail metadata panel, metadata search, template defaults, and graph edges are implemented for the browser prototype. There is no task database engine, recurring task engine, reminder engine, native notification path, dependency engine, mobile capture, or calendar-linked scheduling.
...
| Pages         | Tasks                            | [PARTIAL]                          | Dedicated `/tasks` route/list plus project-linked task section and task metadata panel exist                     | Typed task metadata in item metadata                                             | localStorage prototype                                              | Helper/search/graph/template/product-map tests and browser QA                       | No task database engine, recurrence, reminders, notifications, dependencies, or calendar scheduling                         | Task views and scheduling after relation targets mature             |
...
- Not implemented yet: task database engine, saved task views, kanban, recurring tasks, reminders, native notifications, calendar scheduling automation, dependency engine, AI planning, team/collaboration, and mobile capture.
