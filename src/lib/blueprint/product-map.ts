...
export const productModules: ProductModule[] = [
  ...
  },
  {
    ...
    currentTruth:
      "Task metadata, provider-backed creation, dedicated Tasks route/list, board UI, timeline UI, recurrence metadata, project-linked editing, task page metadata, search metadata, graph edges, and templates exist. Saved task views, recurrence generation, reminders, native notifications, dependencies, and calendar scheduling are future.",
    futureReason:
      "Saved task views, recurrence generation, and scheduling should wait until project, people, finance, and calendar relations are stronger.",
    nextPhase:
      "Saved task views, recurrence generation, and scheduling after relation targets mature.",
  },
  {
    id: "people",
    label: "People",
